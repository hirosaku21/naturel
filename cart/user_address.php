...
<head>
  ...
  <link rel="canonical" href="http://heuris.class2/~s39/cart/user_address.php">
  <meta name="robots" content="noindex,nofollow">

  <!-- ogp -->
  <meta property="og:site_name" content="naturel">
  <meta property="og:url" content="http://heuris.class2/~s39/cart/user_address.php">
  ...
  <div class="cus-adress in-container">
    <div class="adress-base">
      <form action="user_address_conf.php" method="post">
        ...
        (番地)<input type="text" name="address3" id="address3"><br>
        ...
        <p><a href="cart.php">買い物かごに戻る</a></p>
      </form>
    </div>
  </div>
  <!-- footer -->
