...
">
  ...
  <link rel="canonical" href="http://heuris.class2/~s39/list.php">
  <meta name="robots" content="noindex,nofollow">

  <!-- ogp -->
  <meta property="og:site_name" content="naturel">
  <meta property="og:url" content="http://heuris.class2/~s39/list.php">
            ...
            <?php foreach ($result_kitchen as $row) : ?>
              <li class="list__item">
                <a href="product.php?id=<?php echo $row['id']; ?>">
                  ...
                  <?php endif; ?>
                  <?php if ($row['category'] == 0) : ?>
                    <p class="list__price"><?= number_format($row['price']) ?>円</p>
                  <?php endif; ?>
                </a>
              </li>
            <?php endforeach; ?>
