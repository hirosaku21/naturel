...
?>
  ...
  <head>
    ...
    <link rel="canonical" href="http://heuris.class2/~s39/product.php?id=<?php echo $result['id']; ?>">
    <meta name="robots" content="noindex,nofollow">

    <!-- ogp -->
    <meta property="og:site_name" content="naturel">
    <meta property="og:url" content="http://heuris.class2/~s39/product.php?id=<?php echo $result['id']; ?>">
    <meta property="og:type" content="article">
    <meta property="og:title" content="<?php echo $result['name']; ?>">
    <meta property="og:description" content="<?php echo $result['detail']; ?>">
    <meta property="og:image" content="http://heuris.class2/~s39/img/ogp_photo.jpg">
  ...
  <body id="product">
    ...
    <section class="page section container">
      ...
      <h2 class="page__heading">Product<span>商品紹介</span></h2>
    </section>
      ...
      <section class="product section container">
        <div class="product__wrap">
          ...
          <div class="product__wrap__right">
            ...
            <p class="product__price"><?php echo number_format($result['price']); ?>円（税込み）</p>
